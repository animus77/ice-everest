...
@elseif($sell->balance == 0 && $sell->order == 1)
    <tr class="border-b border-blue-400">
        <td class="text-sm w-3/12 text-blue-400">{{ $sell->user->ref }}</td>
        <td class="text-sm text-center w-1/12 text-blue-400">{{ $sell->amount }}</td>
        <td class="text-sm text-center w-1/12 text-blue-400">${{ $sell->paid_amount }}</td>
        <td class="text-sm text-center w-1/12 text-blue-400">${{ $sell->debt_amount }}</td>
