    ...
    <x-card size="m-2">
        ...
        <div class="p-2">
            ...
            @error('name')
                <span>{{ $message }}</span>
            @enderror
            <button wire:click.prevent='store()' class="bg-blue-400 py-1 px-2 mt-2 font-semibold hover:bg-blue-300 rounded shadow">Guardar</button>
        </div>
    </x-card>
        ...
        <table class="bg-gray-200 shadow-lg">
            ...
            <tbody>
                ...
                <tr class="border-b-2 border-white">
                    <td class="p-2 text-center">{{ $equipment->id }}</td>
                    <td class="p-2 text-center">{{ $equipment->name }}</td>
                    <td class="p-2 text-center">
                        <button wire:click.prevent='destroy({{ $equipment->id }})' class="bg-red-400 py-1 px-2 mt-2 font-semibold hover:bg-red-300 rounded shadow">Eliminar</button>
                    </td>
                </tr>
                @empty
